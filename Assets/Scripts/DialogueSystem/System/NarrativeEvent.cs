...
namespace DialogueQuests
{
    ...
    public class NarrativeEvent : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                List<Actor> actor_list = Actor.GetAllActor(trigger_actor);
        ...
        public void Trigger(Actor player = null)
        {
        ...
        public void TriggerIfConditionsMet(Actor player = null)
        {
        ...
        public void TriggerImmediately(Actor player = null)
        {
            if (NarrativeManager.Get().GetCurrent() != this)
            {
                last_triggerer = player;
